...
import {
  ALLTUTORS_GET_SUCCESS,
  DETAILS_ADD_SUCCESS,
  DETAILS_FAILURE,
  DETAILS_GET_SUCCESS,
  DETAILS_REQUEST,
  TUTOR_DETAILS_ADD_SUCCESS,
} from "./actionTypes";
...
export const addstudentDetails = (detailsObj, token) => (dispatch) => {
  ...
  axios
    .post(`${baseUrl}/api/student/create`, detailsObj, {
      headers: {
...
export const addTutorDetails = (payload, token) => (dispatch) => {
  dispatch({ type: DETAILS_REQUEST });
  axios
    .post(`${baseUrl}/api/tutor/addData`, payload, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const getTutorDetails = (token) => (dispatch) => {
  dispatch({ type: DETAILS_REQUEST });
  axios
    .get(`${baseUrl}/api/tutor/gettutor`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
